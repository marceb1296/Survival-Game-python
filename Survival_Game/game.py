...
class Game():
    ...
    def find_cabin(self):
        ...
        if self.cabaña_show == 1:
            ...
            if ganzua == 0 and cuerda == 0 and flechas == 0:
                artefacto = 0
                self.go_cabaña(madera_random, piedra_random, carne_random, cuero_random, artefacto, 0)
                #thread = threading.Thread(target=self.go_cabaña, args=(madera_random, piedra_random, carne_random, cuero_random, artefacto, 0))
                #thread.start()
            elif ganzua == 1 and cuerda == 0 and flechas == 0:
                self.go_cabaña(madera_random, piedra_random, carne_random, cuero_random, ganzua, 1)
                
                #thread = threading.Thread(target=self.go_cabaña, args=(madera_random, piedra_random, carne_random, cuero_random, ganzua, 1))
                #thread.start()
            elif ganzua == 0 and cuerda == 1 and flechas == 0:
                self.go_cabaña(madera_random, piedra_random, carne_random, cuero_random, cuerda, 2)
                
               #thread = threading.Thread(target=self.go_cabaña, args=(madera_random, piedra_random, carne_random, cuero_random, cuerda, 2))
                #thread.start()
            elif ganzua == 0 and cuerda == 0 and flechas == 1:
                self.go_cabaña(madera_random, piedra_random, carne_random, cuero_random, flechas, 3)
                
                #thread = threading.Thread(target=self.go_cabaña, args=(madera_random, piedra_random, carne_random, cuero_random, flechas, 3))
                #thread.start()
    ...
    def go_cabaña(self, madera, piedra, carne, cuero, pieza, nombre):
